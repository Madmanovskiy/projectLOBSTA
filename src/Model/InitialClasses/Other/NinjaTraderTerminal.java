...
public interface NinjaTraderTerminal extends Library {
    NinjaTraderTerminal INSTANCE = (NinjaTraderTerminal) Native.loadLibrary("NtDirect", NinjaTraderTerminal.class);
